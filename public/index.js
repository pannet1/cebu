...
const _getScripQuoteDetails = (ulTkn) =>  {
...
async function longOnlyTrades  (ul1, ce1, pe1)  {                    
   ...
   await _positionBook().then((positionBook) => {                 
    ...
    await _orderStatus().then((orders) => {                                                     
    ...
    await _getScripQuoteDetails(ulTkn).then((ulData) => {                                          
        if (ulData.stat == "Ok") {                                
            ...
            if ( // entries
                ...
                {                           
                     _getScripQuoteDetails(ceTkn).then((scripDetails) => {                                                                                   
                      ...
                      _getScripQuoteDetails(peTkn).then((scripDetails) => {                                                                           
                        const ltp = parseFloat(scripDetails.LTP);                                     
